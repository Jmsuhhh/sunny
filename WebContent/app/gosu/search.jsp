...
<body>
    ...
    <div class="headsearch">
      <form action="${pageContext.request.contextPath}/gosu/searchOk.qs" class="expertsearch" method="post">
        <input type="text" placeholder="분야를 입력해 식고수 찾기" class="searchtext" name="sv"/>
        <button class="s-btn" >
          검색
        </button>
      </form>
