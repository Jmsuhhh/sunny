              ...
              <div class="profile-introduce">
                <div class="profile-content-wrap">
                  <div class="profile-content">
                    <p>한 줄 소개글을 작성 해 주세요</p>
                  </div>
                  <div class="profile-modify-btn">
                    <button type="button" class="modify-btn-ready">
                      <img src="${pageContext.request.contextPath}/assets/img/myPage/icon_pen.png" alt="" />
                    </button>
                  </div>
                </div>
        ...
        <div class="main3--bottom">
          ...
          <ul class="story-list-ul">
            ...
            <li class="story-list">
              <a href="#"
                ><img
                  src="https://www.shouse.garden/data/photo/s230225_08285810718.jpeg"
                  alt=""
                />
                <p>20230302</p></a
              >
            ...
            <li class="story-list">
              <a href="#"
                ><img
                  src="https://www.shouse.garden/data/photo/s230314_2046509890.jpeg"
                  alt=""
                />
                <p>20230303</p></a
              >
            ...
            <li class="story-list">
              <a href="#"
                ><img
                  src="https://www.shouse.garden/data/photo/s230305_1631558251.jpg"
                  alt=""
                />
                <p>20230304</p></a
              >
    ...
    <article class="grade-modal-box none">
      <div class="grade-modal">
        <div class="grade-content">
          ...
          <div class="grade2">
            <h1>식고수</h1>
            <p>자신만의 질문게시판에서 질문과 답변으로 <br> 다른 식집사님들과 소통할 수 있습니다.</p>
          </div>
