...
<head>
  ...
  <link rel="stylesheet" href="/assets/css/joinOk.css">
  <style>
    @font-face {
  ...
  <div class="container">
    ...
    <div class="main-container">
      <div class="mem-joinOk">
        ...
        <div class="subtitle">새로운 아이디는 ${param.userId}입니다.</div>
        <form action="${pageContext.request.contextPath}/user/joinOk.us">
          <button type="button" class="main-button" onclick="location.href='/main/mainOk.ma'">메인으로 가기</button>
