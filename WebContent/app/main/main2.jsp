...
<body>
        ...
        <ul class="main1-slide-ul">
          <li class="banner">
            <a href="${pageContext.request.contextPath}/story/storyListOk.st">
              <p class="banner1">우리집 반려식물 이야기</p>
              <img src="${pageContext.request.contextPath}/assets/img/main/mainBanner1.jpg" alt="">
              </a></li>
          <li class="banner">
            <a href="${pageContext.request.contextPath}/gosu/searchOk.gu">
              <p class="banner2">식고수에게 물어보세요</p>
              <img src="${pageContext.request.contextPath}/assets/img/main/mainBanner2.jpg" alt="">
              </a></li>
          <li class="banner">
            <a href="${pageContext.request.contextPath}/app/algorithm/index.jsp">
              <p class="banner3">나에게 꼭 맞는 반려식물찾기</p>
              <img src="${pageContext.request.contextPath}/assets/img/main/mainBanner3.jpg" alt="">
              </a></li>
    ...
    <section class="main2">
      ...
      <div class="main2-top">
        ...
        <a href="${pageContext.request.contextPath}/story/storyListOk.st">더보기 ></a>
      </div>
        ...
        <ul class="main2-story-list-ul">
          <li class="main2-story-list">
            <div class="main2-story-list-user">
              ...
              <a href="#">
                <div class="story-user-photo"><img src="" alt=""></div>
                <p>닉네임</p>
              </a>
            </div>
            <div class="main2-story-list-content">
              ...
              <a href="#">
                <!-- 스토리커버사진, 제목 -->
                <div class="story-cover-photo"><img src="" alt=""></div>
                <p>제목</p>
              </a>
            </div>
          </li>
    ...
    <section class="main3">
      <article class="main3-wrap">
            ...
            <li class="main3-gosu-li">
              ...
              <a href="#">
                <div class="main3-gosu-name">
                  <!-- 식고수이름 span에 꽂아준다 -->
                  <h3>식고수 <span>홍길동</span>님에게</h3>
                  <h3>물어보세요</h3>
                </div>
                <!-- 식고수프로필사진 꽂아준다 -->
                <div class="main3-gosu-photo"><img src="#" alt=""></div>
                <!-- 식물분야 span에 꽂아준다 -->
                <p><span>칼라데아</span> 키우는 꿀팁!</p>
              </a>
            </li>
          </ul>
        </div>
        <div class="main3-right">
          <!-- 식고수리스트페이지로이동 -->
          <a href="${pageContext.request.contextPath}/gosu/searchOk.gu" class="to-gosu-list-page">
            <div class="main3-right-inner">
              <p>식물마다 노하우가 달라요, <br>
                우리집 반려식물에 꼭 맞는 노하우를 알려주실<br>더 많은 식고수님들을 찾아보세요!
              </p>
            </div>
          </a>
        </div>
    ...
    <section class="main4">
      <!-- 식물찾기 알고리즘 페이지로 이동 -->
      <div class="main4-box" style="background-image:url('${pageContext.request.contextPath}/assets/img/main/mainBanner3.jpg')">
        <a href="${pageContext.request.contextPath}/app/algorithm/index.jsp">
