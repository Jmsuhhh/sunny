...
<title>1번</title>
    ...
    />
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/algorithm/testOne.css" />
</head>
<body>
    <section id="qna" class="mx-auto my-5 py-5 px-3">
      ...
      <a href="${pageContext.request.contextPath}http://127.0.0.1:5500/html/FindMyPlant/main/index.html">
        <img src="${pageContext.request.contextPath}/assets/img/algorithm/index/home.png" style="width: 70px; position: relative; left:320px;"></a>
      <br class="questionContainer">
