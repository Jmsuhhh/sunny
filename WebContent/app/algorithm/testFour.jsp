...
<title>4번</title>
    ...
    />
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/algorithm/testFour.css" />
</head>
<body>
	<section id="qna" class="mx-auto my-5 py-5 px-3">
      ...
      <div class="answerContainer">
        <a href="${pageContext.request.contextPath}http://127.0.0.1:5500/html/FindMyPlant/test5/test5.html">
        <ul>
