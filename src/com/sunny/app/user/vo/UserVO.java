...
public class UserVO {
	...
	public String toString() {
		return "UserVO [userNumber=" + userNumber + ", userId=" + userId + ", userPassword=" + userPassword
				...
				+ ", gradeNumber=" + gradeNumber + ", fieldName=" + fieldName + ", getUserNumber()=" + getUserNumber()
				...
				+ ", getUserEmail()=" + getUserEmail() + ", getUserDate()=" + getUserDate() + ", getUserComment()="
				+ getUserComment() + ", getGradeNumber()=" + getGradeNumber() + ", getFieldName()=" + getFieldName()
